                ...
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${products}" var="product">
                            <tr>
                                <td><img src="${basePath}${product.picture}" class="img-responsive center-block"
                                         style="height:30px; weight:30px;"></td>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                                       data-target="#ProductEditDialog"
                                       onclick="editProduct(${product.productID})">修改</a>
                                    <a href="#" class="btn btn-danger btn-xs"
                                       onclick="deleteProduct(${product.productID})">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${pageinfo.hasPreviousPage }">
                            <li>
                                <a href="${pageContext.request.contextPath }/product/findProduct.action?pn=${pageinfo.pageNum-1}"
                                   aria-label="Previous">
                        ...
                        <c:forEach items="${pageinfo.navigatepageNums}" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageinfo.pageNum }">   
                                <li>
                                    <a href="${pageContext.request.contextPath}/product/findProduct.action?pn=${page_Num}">${page_Num}</a>
                                </li>
                                   
                                                     </c:if>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/product/findProduct.action?pn=${pageinfo.pages}">末页</a>
                        </li>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="new_Product_form" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_productName" placeholder="鲜花名称"
                                   name="productName"/>
                        </div>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="edit_Product_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_productName" placeholder="鲜花名称"
                                   name="productName"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" id="edit_picture" placeholder="联系地址"
                                   name="picture"/>
                        </div>
                    </div>
                </form>
